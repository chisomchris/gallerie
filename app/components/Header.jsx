    ...
    return (
        <header className='shadow-md sticky top-0 bg-white left-0'>
            <div className='wrapper flex items-center'>
                ...
                <input type='search' onChange={onChange} value={filter} placeholder='Search Here...' className='ml-auto px-4 py-1 w-full border-[1px] border-[#3333] border-solid outline-none focus:border-[#333e] md:w-fit md:mr-auto' />
